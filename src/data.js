...
export const PROJECTS = [
  ...
  {
    id: 7,
    name: { en: 'House in a village in Mtskheta', ge: 'სახლი სოფელში მცხეთაში' },
    year: '2024',
    type: { en: 'Residential', ge: 'საცხოვრებელი' },
    cover: '/images/project-7/GA01.png',
    gallery: [
      '/images/project-7/GA01.png',
      '/images/project-7/GA02.png',
      '/images/project-7/GA03.png',
      '/images/project-7/GA04.png',
      '/images/project-7/GA05.png',
    ],
  },
  {
    id: 8,
    name: { en: 'The second option is a house in a village in Mtskheta', ge: 'მეორე ვარიანტი - სახლი სოფელში მცხეთაში' },
    year: '2024',
    type: { en: 'Residential', ge: 'საცხოვრებელი' },
    cover: '/images/project-8/BK01.png',
    gallery: [
      '/images/project-8/BK01.png',
      '/images/project-8/BK02.png',
      '/images/project-8/BK03.png',
      '/images/project-8/BK04.png',
      '/images/project-8/BK05.png',
      '/images/project-8/BK06.png',
      '/images/project-8/BK07.png',
    ],
  },
]
